...
@Component({
  selector: 'app-staffing-insights',
  templateUrl: './staffing-insights.component.html'
})
export class StaffingInsightsComponent implements OnInit,OnDestroy {
  url = `${environment.settings.tableauStaffingInsightsReportUrl}`;
  ...
  private loadTableauDashboard() {
    this.placeholderDiv = document.getElementById('vizContainerSI');
