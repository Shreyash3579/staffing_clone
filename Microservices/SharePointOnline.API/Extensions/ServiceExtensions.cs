...
using SharePointOnline.API.Core.Services;
...
namespace SharePointOnline.API.Extensions
{
    public static class ServiceExtensions
    {
        public static IServiceCollection RegisterAppServices(this IServiceCollection services)
        {
            ...
            #region Services
            services.AddScoped<ISMAPMissionsService, SMAPMissionsService>();
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Title = "SharePoint Online Connector API",
                    Version = "v1",
                    Description = "Get data from SharePoint Online Sites"
                });
