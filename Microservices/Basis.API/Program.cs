...
if (env.ApplicationName != Environments.Production)
{
    ...
    {
#if DEBUG
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Basis API V1");
#else
        c.SwaggerEndpoint("/basisApi/swagger/v1/swagger.json", "Basis API V1");
#endif
    });
}
