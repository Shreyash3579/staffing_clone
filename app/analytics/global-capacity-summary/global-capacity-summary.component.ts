...
@Component({
  selector: 'app-global-capacity-summary',
  templateUrl: './global-capacity-summary.component.html'
})
export class GlobalCapacitySummary implements OnInit,OnDestroy {
  coreServiceSub: any;
  userPreferences: UserPreferences;
  userPreferenceSupplyGroups: UserPreferenceSupplyGroup;
  url = `${environment.settings.tableauGlobalCapacitySummaryUrl}`;
  ...
  private loadTableauDashboard() {
    this.placeholderDiv = document.getElementById('vizContainerGCS');
