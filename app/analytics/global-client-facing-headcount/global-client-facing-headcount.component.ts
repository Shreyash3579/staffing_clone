...
@Component({
  selector: "app-global-client-facing-headcount",
  templateUrl: "./global-client-facing-headcount.component.html"
})
export class GlobalClientFacingHeadcountComponent implements OnInit,OnDestroy {
  coreServiceSub: any;
  userPreferences: UserPreferences;
  userPreferenceSupplyGroups: UserPreferenceSupplyGroup;
  url = `${environment.settings.tableauGlobalClientFacingHeadCountReportUrl}`;
  ...
  private loadTableauDashboard() {
    this.placeholderDiv = document.getElementById('vizContainerGCFH');
